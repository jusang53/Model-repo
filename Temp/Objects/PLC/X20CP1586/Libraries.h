...
__asm__(".ascii \"iecfile \\\"Logical/Libraries/pctr_fun/pctr_fun.fun\\\" scope \\\"global\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Logical/Libraries/pctr_fun/pctr_fun.typ\\\" scope \\\"global\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Logical/Libraries/pctr_fun/pctr_fun.var\\\" scope \\\"global\\\"\\n\"");
...
#endif
#ifdef _PCTR_FUN_EXPORT
	__asm__(".ascii \"plcexport \\\"pctrFub\\\" FUB\\n\"");
#endif
